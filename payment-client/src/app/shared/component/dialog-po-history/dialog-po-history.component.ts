...
@Component({
  selector: 'app-dialog-po-history',
  templateUrl: './dialog-po-history.component.html',
  styleUrls: ['./dialog-po-history.component.scss'],
})
export class DialogPoHistoryComponent implements OnInit {
  listDocument = [];
  listBackupDocument = [];
  listPaymentBlock = [
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogPoHistoryComponent>,
