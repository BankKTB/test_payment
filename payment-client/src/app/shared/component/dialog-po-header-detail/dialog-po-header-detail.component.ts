...
@Component({
  selector: 'app-dialog-po-header-detail',
  templateUrl: './dialog-po-header-detail.component.html',
  styleUrls: ['./dialog-po-header-detail.component.scss'],
})
export class DialogPoHeaderDetailComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogPoHeaderDetailComponent>,
  ...
  ngOnInit() {
    ...
    console.log(this.data.headerText);
    ...
    if (this.data.egpData) {
      this.listDocument = [];
      this.saveEgpData(this.data.egpData);
