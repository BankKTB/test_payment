...
@Component({
  selector: 'app-dialog-search-parameter-generate-file',
  templateUrl: './dialog-search-parameter-generate-file.component.html',
  styleUrls: ['./dialog-search-parameter-generate-file.component.scss'],
})
export class DialogSearchParameterGenerateFileComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<DialogSearchParameterGenerateFileComponent>,
  ...
  searchAllParameter() {
    this.generateFileService.searchByValue('**').then((result) => {
      console.log(result);
