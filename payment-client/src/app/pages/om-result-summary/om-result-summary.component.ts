...
@Component({
  selector: 'app-om-result-summary',
  templateUrl: './om-result-summary.component.html',
  styleUrls: ['./om-result-summary.component.scss'],
})
export class OmResultSummaryComponent implements OnInit {
  button = 'Submit';
  ...
  ngOnInit() {
    ...
    this.sidebarService.updateNowPage('om-result-summary');
