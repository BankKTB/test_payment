...
@Component({
  selector: 'app-om-pto',
  templateUrl: './om-pto.component.html',
  styleUrls: ['./om-pto.component.scss'],
})
export class OmPtoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.sidebarService.updateNowPage('omPto');
