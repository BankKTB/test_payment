...
@Component({
  selector: 'app-generate-file-result',
  templateUrl: './generate-file-result.component.html',
  styleUrls: ['./generate-file-result.component.scss'],
})
export class GenerateFileResultComponent implements OnInit {
