...
@Component({
  selector: 'app-view-sum-file-condition',
  templateUrl: './view-sum-file-condition.component.html',
  styleUrls: ['./view-sum-file-condition.component.scss'],
})
export class ViewSumFileConditionComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.sidebarService.updateNowPage('view-sumFileCondition');
