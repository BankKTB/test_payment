...
@Entity
@Table(name = "GIRO_FILE_DETAIL")
@Getter
@Setter
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id")
public class GIROFileDetail {

  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "GIRO_FILE_DETAIL_SEQ")
  @SequenceGenerator(sequenceName = "GIRO_FILE_DETAIL_SEQ", allocationSize = 1, name = "GIRO_FILE_DETAIL_SEQ")
  private Long id;
