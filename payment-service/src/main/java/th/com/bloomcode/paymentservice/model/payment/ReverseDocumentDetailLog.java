...
@NoArgsConstructor
public
class ReverseDocumentDetailLog extends BaseModel {

    public static final String TABLE_NAME = "REVERSE_DOCUMENT_DETAIL_LOG";


    public static final String COLUMN_NAME_REVERSE_DOCUMENT_DETAIL_LOG = "ID";
