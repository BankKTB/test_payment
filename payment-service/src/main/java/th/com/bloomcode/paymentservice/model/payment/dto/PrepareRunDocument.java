...
@Setter
@NoArgsConstructor
public class PrepareRunDocument extends BaseModel {
    ...
    public String uniqueAttributes() {
        return originalCompanyCode + originalDocumentNo + originalFiscalYear;
    }

    @Override
    public String toString() {
        return "PrepareRunDocument{" +
