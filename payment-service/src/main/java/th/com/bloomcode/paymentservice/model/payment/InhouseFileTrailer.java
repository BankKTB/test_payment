...
@Setter
@NoArgsConstructor
public class InhouseFileTrailer extends BaseModel {

  public static final String TABLE_NAME = "INHOUSE_FILE_TRAILER";

  public static final String COLUMN_NAME_INHOUSE_FILE_TRAILER_ID = "ID";
  ...
  public static final String COLUMN_NAME_INHOUSE_FILE_HEADER_ID = "INHOUSE_FILE_HEADER_ID";
  ...
  private Long inhouseFileHeaderId;
