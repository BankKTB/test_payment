...
@Setter
@NoArgsConstructor
public class UnBlockDocumentMQ extends BaseModel {

    public static final String TABLE_NAME = "UNBLOCK_DOCUMENT_MQ";
    ...
    ,String reverseCompanyCode, String reverseDocumentType, String reverseOriginalFiscalYear, String reverseOriginalDocumentNo) {
        ...
        this.reverseCompanyCode = reverseCompanyCode;
        this.reverseDocumentType = reverseDocumentType;
