...
@Service
@Slf4j
public class CompanyPayingPayMethodConfigServiceImpl implements CompanyPayingPayMethodConfigService {
    private final CompanyPayingPayMethodConfigRepository companyPayingPayMethodConfigRepository;

    public CompanyPayingPayMethodConfigServiceImpl(CompanyPayingPayMethodConfigRepository companyPayingPayMethodConfigRepository) {
    ...
    public CompanyPayingPayMethodConfig findOneById(Long id) {
        return this.companyPayingPayMethodConfigRepository.findById(id).orElse(null);
    }
}
