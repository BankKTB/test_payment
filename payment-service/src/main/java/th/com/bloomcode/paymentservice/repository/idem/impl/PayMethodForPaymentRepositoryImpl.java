...
@Repository
@Slf4j
public class PayMethodForPaymentRepositoryImpl extends MetadataJdbcRepository<PayMethodConfig, Long>
    implements PayMethodForPaymentRepository {
  ...
  public PayMethodForPaymentRepositoryImpl(
      @Qualifier("idemJdbcTemplate") JdbcTemplate jdbcTemplate) {
    super(
  ...
  public List<PayMethodConfig> findAllOrderByCountryAscPayMethodAsc() {
    ...
    sql.append("           PA.TH_CAPAYMENTMETHOD_ID AS ID,           ");
    ...
    sql.append("          PA.CREATEDBY AS CREATED_BY,           ");
    sql.append("          PA.UPDATED,           ");
    sql.append("          PA.UPDATEDBY AS  UPDATED_BY,           ");
    sql.append("          PA.ISACTIVE AS ACTIVE          ");
