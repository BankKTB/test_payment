...
@Setter
@NoArgsConstructor
public class ProposalLogSum extends BaseModel {

    public static final String TABLE_NAME = "PROPOSAL_LOG_SUM";

    public static final String COLUMN_NAME_PROPOSAL_LOG_SUM_ID = "ID";
