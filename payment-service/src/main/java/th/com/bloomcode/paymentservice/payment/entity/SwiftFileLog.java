...
@Entity
@Table(name = "SWIFT_FILE_LOG")
@Getter
@Setter
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id")
public class SwiftFileLog {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SWIFT_FILE_LOG_SEQ")
    @SequenceGenerator(sequenceName = "SWIFT_FILE_LOG_SEQ", allocationSize = 1, name = "SWIFT_FILE_LOG_SEQ")
    private Long id;
