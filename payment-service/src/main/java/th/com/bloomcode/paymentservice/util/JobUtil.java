...
import th.com.bloomcode.paymentservice.job.PersistableCronTriggerFactoryBean;
...
public class JobUtil {
	 ...
	 * @return Trigger
	 */
	protected static Trigger createCronTrigger(String triggerName, Timestamp startTime, String cronExpression, int misFireInstruction){
	 ...
	 * @return Trigger
	 */
	public static Trigger createSingleTrigger(String triggerName, Timestamp startTime, int misFireInstruction){
